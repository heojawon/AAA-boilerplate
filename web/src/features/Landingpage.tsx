import { Smartphone, BookOpen, Flame, ArrowRight, Zap } from "lucide-react";
...
export default function Landingpage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans antialiased selection:bg-primary/30 selection:text-primary-dark">
            {/* Top Navbar */}
                ...
                <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2 cursor-pointer group">
                        ...
                        <span className="font-lexend font-extrabold text-xl tracking-tight text-slate-900">
                            Move<span className="text-primary">Up</span>
                        </span>
                    </div>
                    <Link
                        to="/auth"
                        className="inline-flex items-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-on-primary transition-all duration-200 hover:bg-primary-dark hover:shadow-md active:scale-95"
                    >
                        무료로 시작하기
                    </Link>
                </div>
            ...
            <div className="space-y-16 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative bg-linear-to-br from-slate-900 via-primary-dark to-slate-900 text-white rounded-3xl p-8 md:p-12 overflow-hidden shadow-2xl">
                    <div className="absolute top-0 right-0 w-80 h-80 bg-primary/10 rounded-full blur-3xl animate-pulse-slow"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
                        <div className="lg:col-span-7 space-y-6 text-left max-w-2xl">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/20 text-primary-light text-xs font-bold font-lexend tracking-wide">
                                <Zap className="w-3.5 h-3.5 fill-primary-light" />
                                청소년 웰니스 웹
                            </div>
                            ...
                            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight text-white tracking-tight">
                                ...
                                <span className="text-primary-light relative inline-block">
                                    게임처럼 즐겁게
                                    <span className="absolute bottom-1 left-0 w-full h-1 bg-primary-light/30 rounded-full"></span>
                                </span>
                            </h1>
                            ...
                            <div className="pt-2 flex flex-wrap gap-4">
                                <button
                                    className="bg-primary hover:bg-primary-dark active:scale-95 text-on-primary font-bold px-7 py-4 rounded-2xl text-sm md:text-base transition-all flex items-center gap-2.5 shadow-lg shadow-primary/20"
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center pb-3 border-b border-slate-800">
                                        <div className="flex items-center gap-2">
                                            <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary-light font-bold text-xs">
                                                M
                                            </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                                            <div className="bg-primary-light h-full w-[60%] rounded-full"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 bg-slate-900/50 p-3 rounded-xl border border-slate-800/80">
                                        <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center text-primary-light text-lg">
                                            🌱
                                        </div>
                                        <div>
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-3xl p-8 md:p-12 w-full mx-auto space-y-10">
                    <div className="text-center space-y-2">
                        <span className="text-xs font-bold text-primary uppercase tracking-widest">
                            How It Works
                        </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                        <div className="space-y-3">
                            <div className="w-10 h-10 rounded-full bg-primary text-on-primary font-extrabold flex items-center justify-center font-lexend text-base shadow-md">
                                1
                            </div>
                ...
                <div className="text-center py-10">
                    ...
                    <button
                        className="bg-primary hover:bg-primary-dark active:scale-95 text-on-primary font-bold px-10 py-4.5 rounded-2xl text-base transition-all shadow-xl shadow-primary/20"
                        onClick={() => navigator("/auth")}
                    >
                        무료로 오늘의 퀘스트 시작하기
                    </button>
